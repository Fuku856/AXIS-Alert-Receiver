...
[Files]
Source: "{#MySourceDir}\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "config.json,icon.ico,README.md,*.pyc,__pycache__,installer.iss,{#MyAppExeName}"
